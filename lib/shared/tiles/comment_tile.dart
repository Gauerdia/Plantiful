...
class CommentTile extends StatelessWidget {
  ...
  CommentTile({this.context,this.authUser,this.userProfile, this.comment, this.posting,this.imageBytes});
  ...
  void onClickDeleteComment(Comment comment){
    ...
    DatabaseService(uid: posting.uid).updatePostingCommentsAmount(posting.commentsAmount - 1,"postings");
