...
class OwnFriendsPage extends StatefulWidget {

  final AuthUser authUser;
  final UserProfile authUserProfile;

  const OwnFriendsPage({this.authUser, this.authUserProfile});

  @override
  _OwnFriendsPageState createState() => _OwnFriendsPageState();
}

class _OwnFriendsPageState extends State<OwnFriendsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return authUserProfile != null
      ...
      appBar: ReusableWidgets.getAppBar(
          'My friends', context, widget.authUser, authUserProfile),
  ...
  // Fetch the userProfile of the active user when necessary
  Future<List<UserProfile>> _fetchUserProfileFromFirebase() async{
    ...
    try{
      ...
      userProfileStream.listen(
              (result) {
            print("TEST _fetchUserProfileFromFirebase: " +authUserProfile.toString());
  ...
  // Checks, if the userProfile has been given to this page as an argument
  void _checkForUserProfile() async{
    if(widget.authUserProfile != null){
      ...
      print("_checkForUserProfile from fetching");
