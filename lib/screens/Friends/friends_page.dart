...
import 'package:plantopia1/screens/Friends/friends_tile.dart';
...
class FriendsPage extends StatefulWidget {
  ...
  FriendsPage({this.authUser, this.authUserProfile});
...
// TODO: Der Text, der anzeigt, wie viele Freunde der User hat, der wird
// TODO: noch nicht aktualisiert, nachdem gefetched wurde. Das muss behoben werden.
// TODO: Der Knopf gefällt mir noch nicht
// TODO: We might have the userProfile already due to the page before
// TODO: Give it to this page and fetch only the friends then
// TODO: Wenn man die Searchbar füllt und wieder leert, zeigt er nicht mehr alle an
    ...
    if(searchBarValue == ""){
      return ListView.builder(
          ...
          itemBuilder: (context, index){
            return FriendsTile(context: context, authUser: widget.authUser, userProfile: friendsSelection[index]);
          });
    }else{
      return ListView.builder(
          scrollDirection: Axis.vertical,
          ...
          itemBuilder: (context, index){
            return FriendsTile(context: context, authUser: widget.authUser, userProfile: friendsFilteredSelection[index]);
          });
    }
    }catch(e){
