...
class AllGroupsTile extends StatelessWidget {
  ...
  const AllGroupsTile({Key key, this.context, this.authUser, this.authUserProfile, this.group}) : super(key: key);
  ...
  void _updateGroupslist(String mainUserUid, UserProfile userProfile) async{
    try{
      await DatabaseService(uid : mainUserUid).updateUserData(
        userProfile
        /*
          mainUser.first_name,mainUser.surname, mainUser.shortSum, mainUser.quote, mainUser.date,mainUser.friends, mainUser.groups,
          mainUser.interestedIn, mainUser.location,
          mainUser.plantsCount, mainUser.plantLoverSince, mainUser.activeChatsIds, mainUser.profilePictureId,
          mainUser.profileGalleryPictureIds, mainUser.profileGardenPictureIds, mainUser.profileGardenNames, mainUser.profileGardenAvailabilities,
          mainUser.gardenCategories, mainUser.profileGardenItems
